...
class MasterViewController: UITableViewController, NSFetchedResultsControllerDelegate {
    ...
    override func viewDidLoad() {
        ...
        let url = URL(string: "https://www.googleapis.com/blogger/v3/blogs/10861780/posts?key=AIzaSyAzyX64fltvtamgaLtnk-Z3RbmuhJqLD3U")!
            ...
            if error != nil {
                ...
                if let urlContent = data {
                    ...
                    do {
                        ...
                        if let items = jsonResult["items"] as! Array as? [[String: Any]] {
